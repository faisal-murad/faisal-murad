...
Full-Stack Developer with **2+ years of experience** specializing in building scalable solutions with Node.js, NestJS, and React. I craft robust APIs, implement real-time features, and integrate AI capabilities into modern applications.

When I'm not coding, you'll find me playing guitar 🎸, diving into books 📚, or exploring new technologies.
...
### 📱 [Full Stack Grocery Delivery Application](https://github.com/faisal-murad)
**Tech Stack:** React Native, React.js, Node.js, Express.js, Firebase, Redux Toolkit, Google Maps API

A complete grocery delivery ecosystem with customer app, rider app, and admin dashboard featuring:
- Real-time order tracking with Google Maps integration
- Firebase authentication and push notifications via Cloud Functions
- Efficient state management with Redux Toolkit
- RESTful APIs for admin operations
- **Deployed on Google Play Store**

### 🛍️ [SportsBlend - eCommerce Platform](https://sportsblend.netlify.app)
**Tech Stack:** React.js, Node.js, Express.js, MongoDB, Redux Toolkit

A sports merchandise platform with real-time customization capabilities:
- Dynamic shirt customization (names, numbers)
...
- Building full-stack applications with React, Node.js, and NestJS
- Exploring cloud technologies (AWS S3, Lambda, EC2, CloudWatch)
- Integrating AI capabilities into web applications
- Implementing real-time features with WebSockets and Server-Sent Events
...
- 💼 Portfolio: [faisalmurad.netlify.app](https://faisalmurad.netlify.app)
- 💌 Email: faisalmurad.dev@gmail.com
- 🔗 LinkedIn: [linkedin.com/in/faisalmurad01](https://linkedin.com/in/faisalmurad01)
